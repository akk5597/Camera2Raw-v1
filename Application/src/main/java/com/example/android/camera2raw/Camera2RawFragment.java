...
public class Camera2RawFragment extends Fragment
    ...
    private CameraCaptureSession.CaptureCallback mPreCaptureCallback
        ...
        public void onCaptureStarted(@NonNull CameraCaptureSession session, @NonNull CaptureRequest request, long timestamp, long frameNumber) {
            Log.i(TAG, "Investigation - CaptureStarted: " +
                    "Exposure: " + mExposure +
                    ", Request Exposure: " + request.get(CaptureRequest.SENSOR_EXPOSURE_TIME) +
                    ", Sensitivity: " + mSensitivity +
                    ", Request Sensitivity: " + request.get(CaptureRequest.SENSOR_SENSITIVITY));
...
//            Log.i(TAG, "Investigation - CaptureProgressed: " +
//                    "Exposure: " + mExposure +
//                    "Request Exposure: " + request.get(CaptureRequest.SENSOR_EXPOSURE_TIME) +
//                    "PartialResult Exposure: " + partialResult.get(CaptureResult.SENSOR_EXPOSURE_TIME) +
//                    "Sensitivity: " + mSensitivity +
//                    "Request Sensitivity: " + request.get(CaptureRequest.SENSOR_SENSITIVITY) +
//                    "PartialResult Exposure: " + partialResult.get(CaptureResult.SENSOR_SENSITIVITY));
        ...
        public void onCaptureCompleted(CameraCaptureSession session, CaptureRequest request,
            ...
            Log.i(TAG, "Investigation - CaptureCompleted: " +
                    "Exposure: " + mExposure +
                    "Request Exposure: " + request.get(CaptureRequest.SENSOR_EXPOSURE_TIME) +
                    "PartialResult Exposure: " + result.get(CaptureResult.SENSOR_EXPOSURE_TIME) +
                    "Sensitivity: " + mSensitivity +
                    "Request Sensitivity: " + request.get(CaptureRequest.SENSOR_SENSITIVITY) +
                    "PartialResult Exposure: " + result.get(CaptureResult.SENSOR_SENSITIVITY));
            process(result);
        }
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        // f a new OrientationEventListener.  This is used to handle rotation events like a
...
//        }
        ...
        builder.set(CaptureRequest.SENSOR_SENSITIVITY, mSensitivity);
        builder.set(CaptureRequest.SENSOR_EXPOSURE_TIME, (long) (mExposure*1000000000L));
...
//                }
    ...
    private void captureStillPictureLocked() {
        try {
            ...
            Log.d(TAG, "After request built - Exposure - " + request.get(CaptureRequest.SENSOR_EXPOSURE_TIME)/1000000000d + "; ISO: " + request.get(CaptureRequest.SENSOR_SENSITIVITY));
            Log.d(TAG, "AE_MODE: " + request.get(CaptureRequest.CONTROL_AE_MODE));
    ...
    private static class ImageSaver implements Runnable {
        ...
        private ImageSaver(Image image, File file, CaptureResult result,
                           ...
                           RefCountedAutoCloseable<ImageReader> reader, double exposure, int sensitivity) {
            mImage = image;
            mFile = file;
        ...
        public static class ImageSaverBuilder {
            ...
            public synchronized ImageSaver buildIfComplete() {
                ...
                return new ImageSaver(mImage, mFile, mCaptureResult, mCharacteristics, mContext,
                        mReader, mExposure, mSensitivity);
            }
